...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resource/css/AlbumDetails.css"/>
</head>
<body>
...
<div id="show" style="float: left;">
    ...
    <div id="l-title" style="height: 280px;float: left;width: 1200px;">
        ...
        <div id="list-cover">
            <img src="/resource/img/dish/dish%20(${album.aId}).jpg" height="250px" width="250px" style="float: left;">
        </div>
        <div id="list-name">
            ${album.aName}
        </div>
        <div id="user-name" onclick="window.location.href='/yyg/singerDetails?sId=${album.singer.sId}';">
            ${album.singer.sName}
        </div>
        <div id="lp" class="l-text">流派：${album.aGenre}</div>
        <div id="yz" class="l-text">语种：${album.aLanguage}</div>
        <div id="fxt" class="l-text">发行时间：${album.aTime}</div>
        <div id="company" class="l-text">发行公司：${album.aCompany}</div>
        <div id="style" class="l-text">类型：${album.aType}</div>
        ...
        <div id="list-btns">
            <div class="r-btn1 hand">
                ...
                <c:if test="${user!=null}">
                    <div class="r-text1"
                         onclick="window.open('/yyg/play?songId=${songs.get(0).songId}&uId=${user.uId}&aId=${album.aId}&n=0','_blank');">
                        播放全部
                    </div>
                </c:if>
                <c:if test="${user==null}">
            ...
            <c:if test="${user!=null}">
                <div class="r-btn togray hand">
                    ...
                    <div class="r-text" style="margin-right: 32px;"
                         onclick="window.location.href='/myMusic/insertToMyAlbum?aId=${album.aId}';">
                        收藏
                    </div>
                </div>
            </c:if>
