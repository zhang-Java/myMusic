...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resource/css/yygAlbum.css"/>
...
<div id="show" style="float: left;padding-bottom: 50px">
    ...
    <div id="disc-tab">
        <div class="content">
            <div class="d-tab hand green" style="margin-left: 100px;" onclick="window.location.href='/yyg/yygAlbumByRegion?r1=中国';">内地</div>
            <div class="d-tab hand green" onclick="window.location.href='/yyg/yygAlbumByRegion?r1=香港&r2=台湾';">港台</div>
            <div class="d-tab hand green" onclick="window.location.href='/yyg/yygAlbumByRegion?r1=欧洲&r2=美国';">欧美</div>
            <div class="d-tab hand green" onclick="window.location.href='/yyg/yygAlbumByRegion?r1=韩国';">韩国</div>
            <div class="d-tab hand green" onclick="window.location.href='/yyg/yygAlbumByRegion?r1=日本';">日本</div>
            <div class="d-tab hand green" onclick="window.location.href='/yyg/yygAlbumByRegion?r1=中国';">其他</div>
        </div>
    </div>
    ...
    <div id="sing-page" style="float: left;">

        <div id="page-w" style="float: left; width: 170px;margin-top: 50px;">
            <div id="pages">

                <c:if test="${page>0}">
                    <div id="last-page" class="page"
                         onclick="window.location.href='/yyg/yygAlbum?page=${page-1}';">
                ...
                <c:forEach items="${dishs}" var="dish" varStatus="status" end="${dishs.size()/10}">
                    <div id="parent">
                        <c:if test="${status.count==page+1}">
                            <div id="pagen" onclick="window.location.href='/yyg/yygAlbum?page=${status.count-1}';">
