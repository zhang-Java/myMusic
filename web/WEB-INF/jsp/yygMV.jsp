...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resource/css/yygMV.css"/>

</head>
<body>
<script src="/resource/js/jquery.js"></script>
<script src="/resource/js/yygMV.js" type="text/javascript" charset="utf-8"></script>
...
<div id="show">
    ...
    <div id="discs">
        ...
        <div class="content">
            ...
            <c:forEach items="${songs}" var="song" end="7" >
                <div class="dish-content">
                    <img src="/resource/img/mv/mv%20(${song.mv}).jpg" class="d-cove">
                    <div class="d-name hand green">${song.songName}</div>
                    <div class="d-singer hand green">${song.singer1.sName}</div>
                    <div class="d-singer">${song.time}</div>
                </div>
            </c:forEach>
